...
global.Loop54 = function () {
  ...
  var getRelatedEntities = function getRelatedEntities(entity, callback) {
    /*
    *
  ...
  var search = function search(searchTerm, callback) {
    ...
    */
    ...
    if (options) {
      ...
      if (options.take) {
        parameters['results'] = _extends({}, parameters['results'], { take: options.take });
      }

      if (options.skip) {
        parameters['results'] = _extends({}, parameters['results'], { skip: options.skip });
      }
