...
var Loop54 = {
  ...
  Entity: function Entity(entityType, externalId) {
    this.EntityType = entityType;
    this.ExternalId = externalId;
  },

  RequestOptions: function RequestOptions(use25Url) {
    this.use25Url = use25Url;
  },

  Request: function Request(questName, requestOptions) {
    this.parameters = {};
    this.questName = questName;
    this.options = requestOptions;
  },

  Event: function Event(type, entity, quantity, revenue, orderId) {
    this.Type = type;
    this.Entity = entity;
...
exports.default = Loop54;

},{"./combabillity.js":15,"./cookies.js":16,"axios":1}]},{},[17]);
